<script type="text/javascript">
    $(function() {
        $('#ses_category,#ses_qty_unit').bind('change',function() {
            $('#form-search').attr('action','<?=site_url("selling/search_not_sold")?>').submit();
        });
    });
</script>
            ...
            <div class="col-xs-12 col-sm-12 col-md-10">
                ...
                <div class="panel-content">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Data Ikan/Barang Tidak Dijual</div>
                        <div class="panel-body">
                            ...
                            <div class="navs-product nav-border-bottom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#" class="active">Ikan/Barang Tidak Dijual <span class="badge badge-active"><?=$count_not_sold?></span></a></li>
                                </ul>
                            </div>

                            <div class="filter-product" style="margin-top: 15px;">
                                <form class="form-inline" name="form-search" id="form-search" method="post" action="<?=site_url('selling/search_not_sold')?>">
                                    ...
                                    <input type="text" class="form-control" name="ses_txt_search" value="<?=@$ses_txt_search?>" placeholder="Cari Ikan/Barang">
                                        <span class="input-group-btn">
                                            ...
                                            <a href="<?=site_url('web/location/selling/not_sold')?>" class="btn btn-danger" title="Hapus Filter"><i class="fa fa-times"></i></a>
                                        </span>
                                    </div>
                            ...
                            <div class="category-products">
                                <ul class="products row">
                                    <?php foreach ($list_product_not_sold as $data): ?>
                                                ...
                                                <div class="product-name-price">
                                                    ...
                                                    <center>
                                                        <div class="button-new-product">
                                                            ...
                                                            <a href="#" class="btn btn-sm btn-danger" data-p="<?=$p?>" data-o="<?=$o?>" data-product_id="<?=$data['product_id']?>" id="delete_not_sold" style="width: 93px;"><i class="fa fa-times"></i> Hapus</a>
                                                        </div>
                                                    </center>
                                                </div>
                                            </div>
                                ...
                                <?php if(count($list_product_not_sold) == 0):?>
                                    <ul class="products row">
                            ...
                            <div style="text-align: right;">
                                <ul class="pagination" style="margin-top: 0px; margin-bottom: 0px;">
                                    <?php if($paging->start_link): ?>
                                        <li><a href="<?=site_url("selling/not_sold/$paging->c_start_link/$o") ?>"><span><i class="fa fa-angle-double-left"></i></span></a></li>
                                    <?php endif; ?>
                                    <?php if($paging->prev): ?>
                                        <li><a href="<?=site_url("selling/not_sold/$paging->prev/$o") ?>"><span><i class="fa fa-angle-left"></i></span></a></li>
                                    <?php endif; ?>

                                    <?php for($i = $paging->c_start_link; $i <= $paging->c_end_link; $i++): ?>
                                        <li <?php jecho($p, $i, "class='active'") ?>><a href="<?=site_url("selling/not_sold/$i/$o") ?>"><?=$i ?></a></li>
                                    <?php endfor; ?>

                                    <?php if($paging->next): ?>
                                        <li><a href="<?=site_url("selling/not_sold/$paging->next/$o") ?>"><span><i class="fa fa-angle-right"></i></span></a></li>
                                    <?php endif; ?>
                                    <?php if($paging->end_link): ?>
                                        <li><a href="<?=site_url("selling/not_sold/$paging->c_end_link/$o") ?>"><span><i class="fa fa-angle-double-right"></i></span></a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                            <?php endif;?>
