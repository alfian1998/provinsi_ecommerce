                        ...
                        <div class="panel-body">
                            <div class="navs-product nav-border-bottom">
                                <ul class="nav nav-tabs">
                                    <li><a href="javascript:void(0)" class="active">Laporan Harian</a></li>
                                    <li><a href="<?=site_url('webmin/location/report/monthly')?>">Laporan Bulanan</a></li>
                                </ul>
                            </div>
                            <div class="body-profile">
                                ...
                                <table width="100%" class="table-no-border">
                                    <tr>
                                        <td width="18%"><div class="span10">Tanggal Pembelian</div></td>
                                        <td width="82%">
                                            <div class="span2">
                                                <input type="text" name="ses_billing_date" id="datepicker" class="form-control" placeholder="Tanggal Pembelian" value="<?=@$ses_billing_date?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <a href="<?=site_url('webmin/location/report')?>" class="btn btn-danger bold"><i class="fa fa-times"></i> Clear</a>
                                <span style="margin-left: 20px;"><b>Keterangan : </b> Kolom Filter di Atas Optional</span>
                                <?php if($filter_search == 'true'):?>
                                    <a href="<?=site_url('webmin_report/export_excel_harian')?>" class="btn btn-success bold pull-right"><i class="fa fa-download"></i> Export Excel</a>
                                <?php endif; ?>
                                </form>
                            </div>
