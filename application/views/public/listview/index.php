								...
								<div class="inner row">
									<div class="product-left col-xs-12 col-sm-5 col-md-4">
										<div class="product-thumb">
											<a class="product-img-categories" href="<?=site_url('web/details/'.md5(md5(md5(md5(md5($data['product_id']))))))?>"><img src="<?=base_url()?>assets/images/produk/<?=@$data['first_image']['image_name']?>" class="img-product"></a>
									...
									<div class="product-right col-xs-12 col-sm-7 col-md-8 product-column">
                                        ...
                                        <div class="price-info">
                                            ...
                                            <?php endif; ?>
                                            <br>
                                            <span class="product-city"><img src="<?=base_url()?>assets/images/icon/map-marker.png" class="map-marker"> <?=($data['kel_nm'] && $data['kec_nm'] && $data['kab_nm'] && $data['prov_nm'] !='') ? $data['kel_nm'].', '.$data['kec_nm'].', '.$data['kab_nm'].', '.$data['prov_nm'] : '-' ?></span><br>
