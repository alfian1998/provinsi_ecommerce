<?php
class Payment_Instructions_Model extends CI_Model {
    ...
    function get_data($id=null) {
        $sql = "SELECT * FROM payment_instructions WHERE id=?";
    ...
    function insert() {
        ...
        //
        $outp = $this->db->insert('payment_instructions', $data);
    ...
    function update($id=null) {
        ...
        //
        $this->db->where('id', $id);
        $outp = $this->db->update('payment_instructions', $data);
        return outp_result($outp);
    }

    function delete($id=null) {
        $this->db->where('id', $id);
        $outp = $this->db->delete('payment_instructions');
